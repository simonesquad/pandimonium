...
const api_11 = require("../codegen/conversations/visitor_identification/api");
...
const api_12 = require("../codegen/crm/associations/api");
...
const api_20 = require("../codegen/crm/line_items/api");
const lineItemsModels = __importStar(require("../codegen/crm/line_items/model/models"));
exports.lineItemsModels = lineItemsModels;
const api_21 = require("../codegen/crm/objects/api");
const api_22 = require("../codegen/crm/objects/feedback_submissions/api");
...
class Client {
    constructor(options = {}) {
        ...
        this.authentications = {
            hapikey: new api_23.ApiKeyAuth('query', 'hapikey'),
            oauth2: new api_23.OAuth(),
        };
        ...
        this._oauthDefaultApi = new api_33.DefaultApi();
        this._associationsBatchApi = new api_12.BatchApi();
        this._typesApi = new api_12.TypesApi();
        this._companiesAssociationsApi = new api_13.AssociationsApi();
        this._companiesBasicApi = new api_13.BasicApi();
        this._companiesBatchApi = new api_13.BatchApi();
        this._companiesSearchApi = new api_13.SearchApi();
        this._contactsAssociationsApi = new api_14.AssociationsApi();
        this._contactsBasicApi = new api_14.BasicApi();
        this._contactsBatchApi = new api_14.BatchApi();
        this._contactsSearchApi = new api_14.SearchApi();
        this._dealsAssociationsApi = new api_15.AssociationsApi();
        this._dealsBasicApi = new api_15.BasicApi();
        this._dealsBatchApi = new api_15.BatchApi();
        this._dealsSearchApi = new api_15.SearchApi();
        this._accountingCallbacksApi = new api_16.CallbacksApi();
        this._accountingInvoiceApi = new api_16.InvoiceApi();
        this._accountingSettingsApi = new api_16.SettingsApi();
        this._accountingSyncApi = new api_16.SyncApi();
        this._accountingUserAccountsApi = new api_16.UserAccountsApi();
        this._callingSettingsApi = new api_17.SettingsApi();
        this._cardsApi = new api_18.CardsApi();
        this._cardsSampleResponseApi = new api_18.SampleResponseApi();
        this._feedbackSubmissionsAssociationsApi = new api_22.AssociationsApi();
        this._feedbackSubmissionsBasicApi = new api_22.BasicApi();
        this._feedbackSubmissionsBatchApi = new api_22.BatchApi();
        this._feedbackSubmissionsSearchApi = new api_22.SearchApi();
        this._videoconferencingSettingsApi = new api_19.SettingsApi();
        this._importsCoreApi = new coreApi_1.CoreApi();
        this._lineItemsAssociationsApi = new api_20.AssociationsApi();
        this._lineItemsBasicApi = new api_20.BasicApi();
        this._lineItemsBatchApi = new api_20.BatchApi();
        this._lineItemsSearchApi = new api_20.SearchApi();
        this._objectsAssociationsApi = new api_21.AssociationsApi();
        this._objectsBasicApi = new api_21.BasicApi();
        this._objectsBatchApi = new api_21.BatchApi();
        this._objectsSearchApi = new api_21.SearchApi();
        this._ownersDefaultApi = new api_23.DefaultApi();
        this._pipelinesApi = new api_24.PipelinesApi();
        this._pipelineStagesApi = new api_24.PipelineStagesApi();
        this._productsAssociationsApi = new api_25.AssociationsApi();
        this._productsBasicApi = new api_25.BasicApi();
        this._productsBatchApi = new api_25.BatchApi();
        this._productsSearchApi = new api_25.SearchApi();
        this._propertiesBatchApi = new api_26.BatchApi();
        this._propertiesCoreApi = new api_26.CoreApi();
        this._propertiesGroupsApi = new api_26.GroupsApi();
        this._quotesAssociationsApi = new api_27.AssociationsApi();
        this._quotesBasicApi = new api_27.BasicApi();
        this._quotesBatchApi = new api_27.BatchApi();
        this._quotesSearchApi = new api_27.SearchApi();
        this._schemasDefaultApi = new api_28.DefaultApi();
        this._schemasCoreApi = new api_28.CoreApi();
        this._ticketsAssociationsApi = new api_29.AssociationsApi();
        this._ticketsBasicApi = new api_29.BasicApi();
        this._ticketsBatchApi = new api_29.BatchApi();
        this._ticketsSearchApi = new api_29.SearchApi();
        this._eventsApi = new api_30.EventsApi();
        this._templatesApi = new api_30.TemplatesApi();
        this._tokensApi = new api_30.TokensApi();
        this._eventsEventsApi = new api_31.EventsApi();
        this._transactionalDefaultApi = new api_32.DefaultApi();
        this._settingsApi = new api_34.SettingsApi();
        this._subscriptionsApi = new api_34.SubscriptionsApi();
        ...
        this._generateApi = new api_11.GenerateApi();
    ...
    _retrieveGetAllFunction(getPageFunction) {
        return (limit, after, properties, associations, paginateAssociations, archived, options) => __awaiter(this, void 0, void 0, function* () {
            const limitInternal = limit !== null && limit !== void 0 ? limit : 100;
            let afterInternal = after;
            const result = [];
            let response;
            do {
                response = yield getPageFunction(limitInternal, afterInternal, properties, associations, paginateAssociations, archived, options);
