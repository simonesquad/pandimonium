...
export declare class DefaultApi {
     ...
     */
    create(blogAuthor: BlogAuthor, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    createBatch(batchInputBlogAuthor: BatchInputBlogAuthor, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getPage(createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, sort?: Array<string>, after?: string, limit?: number, archived?: boolean, options?: {
        ...
        response: http.IncomingMessage;
        body: CollectionResponseWithTotalBlogAuthorForwardPaging;
    }>;
    /**
     ...
     */
    update(objectId: string, blogAuthor: BlogAuthor, archived?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
