...
export declare class DefaultApi {
     ...
     */
    getById(contentId: string, type?: 'LANDING_PAGE' | 'BLOG_POST' | 'SITE_PAGE' | 'DOCUMENT' | 'KNOWLEDGE_ARTICLE' | 'LISTING_PAGE', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
