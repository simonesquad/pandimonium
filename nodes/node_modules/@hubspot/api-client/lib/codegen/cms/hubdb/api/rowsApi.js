...
exports.RowsApi = exports.RowsApiApiKeys = void 0;
...
// ===============================================
var RowsApiApiKeys;
(function (RowsApiApiKeys) {
    RowsApiApiKeys[RowsApiApiKeys["hapikey"] = 0] = "hapikey";
})(RowsApiApiKeys = exports.RowsApiApiKeys || (exports.RowsApiApiKeys = {}));
class RowsApi {
    ...
    setApiKey(key, value) {
        this.authentications[RowsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    cloneDraftTableRow(rowId, tableIdOrName, options = { headers: {} }) {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "HubDbTableRowV3");
     ...
     */
    createTableRow(tableIdOrName, hubDbTableRowV3Input, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(hubDbTableRowV3Input, "HubDbTableRowV3Input")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
     ...
     * @param tableIdOrName The ID or name of the table
     */
    getDraftTableRowById(rowId, tableIdOrName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param tableIdOrName The ID or name of the table
     */
    getTableRow(rowId, tableIdOrName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getTableRows(tableIdOrName, properties, after, limit, sort, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/hubdb/tables/{tableIdOrName}/rows'
                .replace('{' + 'tableIdOrName' + '}', encodeURIComponent(String(tableIdOrName)));
            let localVarQueryParameters = {};
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseWithTotalHubDbTableRowV3ForwardPaging");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param tableIdOrName The ID or name of the table
     */
    purgeDraftTableRow(rowId, tableIdOrName, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/hubdb/tables/{tableIdOrName}/rows/{rowId}/draft'
                .replace('{' + 'rowId' + '}', encodeURIComponent(String(rowId)))
                .replace('{' + 'tableIdOrName' + '}', encodeURIComponent(String(tableIdOrName)));
     ...
     */
    readDraftTableRows(tableIdOrName, after, properties, limit, sort, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    replaceDraftTableRow(rowId, tableIdOrName, hubDbTableRowV3Input, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/hubdb/tables/{tableIdOrName}/rows/{rowId}/draft'
                .replace('{' + 'rowId' + '}', encodeURIComponent(String(rowId)))
                .replace('{' + 'tableIdOrName' + '}', encodeURIComponent(String(tableIdOrName)));
     ...
     */
    updateDraftTableRow(rowId, tableIdOrName, hubDbTableRowV3Input, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/cms/v3/hubdb/tables/{tableIdOrName}/rows/{rowId}/draft'
                .replace('{' + 'rowId' + '}', encodeURIComponent(String(rowId)))
                .replace('{' + 'tableIdOrName' + '}', encodeURIComponent(String(tableIdOrName)));
