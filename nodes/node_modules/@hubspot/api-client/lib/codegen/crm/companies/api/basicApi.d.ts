...
export declare class BasicApi {
     ...
     * @param companyId
     */
    archive(companyId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getById(companyId: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getPage(limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
        response: http.IncomingMessage;
        body: CollectionResponseSimplePublicObject;
    }>;
    /**
     ...
     * @param simplePublicObjectInput
     */
    update(companyId: string, simplePublicObjectInput: SimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
