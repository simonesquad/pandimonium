...
class AssociationsApi {
     ...
     */
    archive(companyId, toObjectType, toObjectId, associationType, options = { headers: {} }) {
     ...
     */
    create(companyId, toObjectType, toObjectId, associationType, paginateAssociations, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/companies/{companyId}/associations/{toObjectType}/{toObjectId}/{associationType}'
                .replace('{' + 'companyId' + '}', encodeURIComponent(String(companyId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)))
     ...
     */
    getAll(companyId, toObjectType, paginateAssociations, after, limit, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // verify required parameter 'companyId' is not null or undefined
            if (companyId === null || companyId === undefined) {
                throw new Error('Required parameter companyId was null or undefined when calling getAll.');
            }
            // verify required parameter 'toObjectType' is not null or undefined
            if (toObjectType === null || toObjectType === undefined) {
