...
class BasicApi {
     ...
     * @param companyId
     */
    archive(companyId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/companies/{companyId}'
            ...
            if (companyId === null || companyId === undefined) {
                throw new Error('Required parameter companyId was null or undefined when calling archive.');
            }
    ...
    create(simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/companies';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     */
    getById(companyId, properties, associations, paginateAssociations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/companies/{companyId}'
                .replace('{' + 'companyId' + '}', encodeURIComponent(String(companyId)));
            let localVarQueryParameters = {};
            ...
            // verify required parameter 'companyId' is not null or undefined
            if (companyId === null || companyId === undefined) {
                throw new Error('Required parameter companyId was null or undefined when calling getById.');
            }
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getPage(limit, after, properties, associations, paginateAssociations, archived, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/companies';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseSimplePublicObject");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
    ...
    /**
     * Perform a partial update of an Object identified by `{companyId}`. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
     * @summary Update
     * @param companyId
     * @param simplePublicObjectInput
     */
    update(companyId, simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/companies/{companyId}'
                .replace('{' + 'companyId' + '}', encodeURIComponent(String(companyId)));
            let localVarQueryParameters = {};
