...
exports.SearchApi = exports.SearchApiApiKeys = void 0;
...
(function (SearchApiApiKeys) {
    SearchApiApiKeys[SearchApiApiKeys["hapikey"] = 0] = "hapikey";
...
class SearchApi {
     ...
     */
    doSearch(publicObjectSearchRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/line_items/search';
            ...
            let localVarRequestOptions = {
                ...
                json: true,
                body: models_1.ObjectSerializer.serialize(publicObjectSearchRequest, "PublicObjectSearchRequest")
            };
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseWithTotalSimplePublicObject");
