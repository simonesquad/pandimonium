...
export declare class BasicApi {
     ...
     * @param lineItemId
     */
    archive(lineItemId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getById(lineItemId: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param simplePublicObjectInput
     */
    update(lineItemId: string, simplePublicObjectInput: SimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
