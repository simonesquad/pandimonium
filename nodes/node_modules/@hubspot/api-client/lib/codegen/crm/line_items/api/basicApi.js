...
class BasicApi {
     ...
     * @param lineItemId
     */
    archive(lineItemId, options = { headers: {} }) {
     ...
     */
    getById(lineItemId, properties, associations, paginateAssociations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/line_items/{lineItemId}'
                .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)));
            let localVarQueryParameters = {};
            ...
            // verify required parameter 'lineItemId' is not null or undefined
            if (lineItemId === null || lineItemId === undefined) {
                throw new Error('Required parameter lineItemId was null or undefined when calling getById.');
            }
     ...
     * @param simplePublicObjectInput
     */
    update(lineItemId, simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/line_items/{lineItemId}'
                .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)));
            let localVarQueryParameters = {};
