...
exports.AssociationsApi = exports.AssociationsApiApiKeys = void 0;
...
// ===============================================
var AssociationsApiApiKeys;
(function (AssociationsApiApiKeys) {
    AssociationsApiApiKeys[AssociationsApiApiKeys["hapikey"] = 0] = "hapikey";
})(AssociationsApiApiKeys = exports.AssociationsApiApiKeys || (exports.AssociationsApiApiKeys = {}));
class AssociationsApi {
    ...
    setApiKey(key, value) {
        this.authentications[AssociationsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    archive(lineItemId, toObjectType, toObjectId, associationType, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/line_items/{lineItemId}/associations/{toObjectType}/{toObjectId}/{associationType}'
            ...
            if (lineItemId === null || lineItemId === undefined) {
                throw new Error('Required parameter lineItemId was null or undefined when calling archive.');
            }
     ...
     */
    create(lineItemId, toObjectType, toObjectId, associationType, paginateAssociations, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/line_items/{lineItemId}/associations/{toObjectType}/{toObjectId}/{associationType}'
                .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)))
            ...
            // verify required parameter 'lineItemId' is not null or undefined
            if (lineItemId === null || lineItemId === undefined) {
                throw new Error('Required parameter lineItemId was null or undefined when calling create.');
            }
            // verify required parameter 'toObjectType' is not null or undefined
            if (toObjectType === null || toObjectType === undefined) {
            ...
            if (paginateAssociations !== undefined) {
                localVarQueryParameters['paginateAssociations'] = models_1.ObjectSerializer.serialize(paginateAssociations, "boolean");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
     ...
     */
    getAll(lineItemId, toObjectType, paginateAssociations, after, limit, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/line_items/{lineItemId}/associations/{toObjectType}'
                .replace('{' + 'lineItemId' + '}', encodeURIComponent(String(lineItemId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            // verify required parameter 'lineItemId' is not null or undefined
            if (lineItemId === null || lineItemId === undefined) {
                throw new Error('Required parameter lineItemId was null or undefined when calling getAll.');
            }
            // verify required parameter 'toObjectType' is not null or undefined
            if (toObjectType === null || toObjectType === undefined) {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponseAssociatedId");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
