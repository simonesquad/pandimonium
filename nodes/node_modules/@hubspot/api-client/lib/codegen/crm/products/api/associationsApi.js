...
class AssociationsApi {
     ...
     */
    archive(productId, toObjectType, toObjectId, associationType, options = { headers: {} }) {
     ...
     */
    create(productId, toObjectType, toObjectId, associationType, paginateAssociations, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/products/{productId}/associations/{toObjectType}/{toObjectId}/{associationType}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)))
            ...
            // verify required parameter 'productId' is not null or undefined
            if (productId === null || productId === undefined) {
                throw new Error('Required parameter productId was null or undefined when calling create.');
            }
            // verify required parameter 'toObjectType' is not null or undefined
            if (toObjectType === null || toObjectType === undefined) {
     ...
     */
    getAll(productId, toObjectType, paginateAssociations, after, limit, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // verify required parameter 'productId' is not null or undefined
            if (productId === null || productId === undefined) {
                throw new Error('Required parameter productId was null or undefined when calling getAll.');
            }
            // verify required parameter 'toObjectType' is not null or undefined
            if (toObjectType === null || toObjectType === undefined) {
