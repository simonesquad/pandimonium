...
class BasicApi {
     ...
     * @param productId
     */
    archive(productId, options = { headers: {} }) {
     ...
     */
    getById(productId, properties, associations, paginateAssociations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/products/{productId}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)));
            let localVarQueryParameters = {};
    ...
    /**
     * Perform a partial update of an Object identified by `{productId}`. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
     * @summary Update
     * @param productId
     * @param simplePublicObjectInput
     */
    update(productId, simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/products/{productId}'
                .replace('{' + 'productId' + '}', encodeURIComponent(String(productId)));
            let localVarQueryParameters = {};
