...
class BasicApi {
     ...
     * @param ticketId
     */
    archive(ticketId, options = { headers: {} }) {
     ...
     */
    getById(ticketId, properties, associations, paginateAssociations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}'
                .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)));
            let localVarQueryParameters = {};
     ...
     * @param simplePublicObjectInput
     */
    update(ticketId, simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}'
                .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)));
            let localVarQueryParameters = {};
