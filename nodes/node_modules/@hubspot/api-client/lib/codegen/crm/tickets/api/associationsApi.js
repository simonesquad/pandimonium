...
class AssociationsApi {
     ...
     */
    archive(ticketId, toObjectType, toObjectId, associationType, options = { headers: {} }) {
     ...
     */
    create(ticketId, toObjectType, toObjectId, associationType, paginateAssociations, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/tickets/{ticketId}/associations/{toObjectType}/{toObjectId}/{associationType}'
                .replace('{' + 'ticketId' + '}', encodeURIComponent(String(ticketId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)))
     ...
     */
    getAll(ticketId, toObjectType, paginateAssociations, after, limit, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
