...
export declare class BasicApi {
     ...
     * @param ticketId
     */
    archive(ticketId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getById(ticketId: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param simplePublicObjectInput
     */
    update(ticketId: string, simplePublicObjectInput: SimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
