...
export declare class BasicApi {
     ...
     * @param objectId
     */
    archive(objectType: string, objectId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    create(objectType: string, simplePublicObjectInput: SimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     */
    getById(objectType: string, objectId: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param archived Whether to return only results that have been archived.
     */
    getPage(objectType: string, limit?: number, after?: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param simplePublicObjectInput
     */
    update(objectType: string, objectId: string, simplePublicObjectInput: SimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
