...
export declare class BasicApi {
     ...
     */
    getById(dealId: string, properties?: Array<string>, associations?: Array<string>, paginateAssociations?: boolean, archived?: boolean, idProperty?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
     ...
     * @param simplePublicObjectInput
     */
    update(dealId: string, simplePublicObjectInput: SimplePublicObjectInput, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
