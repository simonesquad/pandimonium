...
class BasicApi {
     ...
     */
    getById(dealId, properties, associations, paginateAssociations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/deals/{dealId}'
                .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)));
            let localVarQueryParameters = {};
    ...
    /**
     * Perform a partial update of an Object identified by `{dealId}`. Provided property values will be overwritten. Read-only and non-existent properties will be ignored. Properties values can be cleared by passing an empty string.
     * @summary Update
     * @param dealId
     * @param simplePublicObjectInput
     */
    update(dealId, simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/deals/{dealId}'
                .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)));
            let localVarQueryParameters = {};
