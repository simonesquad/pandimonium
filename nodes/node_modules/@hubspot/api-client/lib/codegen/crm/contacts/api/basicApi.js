...
class BasicApi {
     ...
     * @param contactId
     */
    archive(contactId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/contacts/{contactId}'
    ...
    create(simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/contacts';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     */
    getById(contactId, properties, associations, paginateAssociations, archived, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/contacts/{contactId}'
                .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
            let localVarQueryParameters = {};
            ...
            // verify required parameter 'contactId' is not null or undefined
            if (contactId === null || contactId === undefined) {
                throw new Error('Required parameter contactId was null or undefined when calling getById.');
            }
     ...
     * @param simplePublicObjectInput
     */
    update(contactId, simplePublicObjectInput, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/objects/contacts/{contactId}'
                .replace('{' + 'contactId' + '}', encodeURIComponent(String(contactId)));
            let localVarQueryParameters = {};
            ...
            // verify required parameter 'contactId' is not null or undefined
            if (contactId === null || contactId === undefined) {
                throw new Error('Required parameter contactId was null or undefined when calling update.');
            }
            // verify required parameter 'simplePublicObjectInput' is not null or undefined
            if (simplePublicObjectInput === null || simplePublicObjectInput === undefined) {
