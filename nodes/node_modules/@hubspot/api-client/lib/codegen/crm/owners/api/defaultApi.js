...
class DefaultApi {
     ...
     * @param idProperty
     */
    getById(ownerId, idProperty, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (idProperty !== undefined) {
                localVarQueryParameters['idProperty'] = models_1.ObjectSerializer.serialize(idProperty, "'id' | 'userId'");
            }
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "PublicOwner");
     ...
     */
    getPage(email, after, limit, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CollectionResponsePublicOwner");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
