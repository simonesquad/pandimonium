...
exports.CardsApi = exports.CardsApiApiKeys = void 0;
...
// ===============================================
var CardsApiApiKeys;
(function (CardsApiApiKeys) {
    CardsApiApiKeys[CardsApiApiKeys["hapikey"] = 0] = "hapikey";
})(CardsApiApiKeys = exports.CardsApiApiKeys || (exports.CardsApiApiKeys = {}));
class CardsApi {
    ...
    setApiKey(key, value) {
        this.authentications[CardsApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    archive(appId, cardId, options = { headers: {} }) {
     ...
     */
    create(appId, cardCreateRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(cardCreateRequest, "CardCreateRequest")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CardResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
                ...
                return new Promise((resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "CardListResponse");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    getById(appId, cardId, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/extensions/cards/{appId}/{cardId}'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)))
                .replace('{' + 'cardId' + '}', encodeURIComponent(String(cardId)));
     ...
     */
    update(appId, cardId, cardPatchRequest, options = { headers: {} }) {
        return __awaiter(this, void 0, void 0, function* () {
            const localVarPath = this.basePath + '/crm/v3/extensions/cards/{appId}/{cardId}'
                .replace('{' + 'appId' + '}', encodeURIComponent(String(appId)))
                .replace('{' + 'cardId' + '}', encodeURIComponent(String(cardId)));
            ...
            let localVarRequestOptions = {
                ...
                useQuerystring: this._useQuerystring,
                json: true,
                body: models_1.ObjectSerializer.serialize(cardPatchRequest, "CardPatchRequest")
            };
            let authenticationPromise = Promise.resolve();
            if (this.authentications.hapikey.apiKey) {
                authenticationPromise = authenticationPromise.then(() => this.authentications.hapikey.applyToRequest(localVarRequestOptions));
